...
class PersonalityBase(BaseModel):
    ...
    personality_prompt: str = Field(..., description="Personality-specific behavior description", min_length=10, alias="personalityPrompt")
...
class PersonalityUpdate(BaseModel):
    ...
    personality_prompt: Optional[str] = Field(None, description="Personality-specific behavior description", min_length=10, alias="personalityPrompt")
